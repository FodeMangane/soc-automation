Avant de construire le workflow, nous devons créer un Bot Slack qui permettra d'envoyer des notifications automatiques au canal SOC.
...
Figure 76: Création de l'application SOC Bot dans l'API Slack
...
Figure 77: Génération du Bot User OAuth Token pour l'intégration Slack
...
Figure 78: Création du canal #soc-alerts et ajout du bot SOC Bot dans Slack
